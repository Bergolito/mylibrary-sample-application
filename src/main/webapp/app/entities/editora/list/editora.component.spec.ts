...
import { sampleWithRequiredData } from '../editora.test-samples';
import { EditoraService } from '../service/editora.service';

import { EditoraComponent } from './editora.component';
import SpyInstance = jest.SpyInstance;

describe('Editora Management Component', () => {
  let comp: EditoraComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(EditoraComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.editoras?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to editoraService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEditoraIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEditoraIdentifier).toHaveBeenCalledWith(entity);

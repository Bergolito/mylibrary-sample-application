...
import { sampleWithRequiredData } from '../livro.test-samples';
...
describe('Livro Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to livroService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLivroIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLivroIdentifier).toHaveBeenCalledWith(entity);

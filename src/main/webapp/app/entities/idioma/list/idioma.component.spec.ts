...
import { sampleWithRequiredData } from '../idioma.test-samples';
...
describe('Idioma Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.idiomas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to idiomaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getIdiomaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getIdiomaIdentifier).toHaveBeenCalledWith(entity);

...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '1ac9f7c0-fa25-4ef9-882c-35060fa66c0b' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('84f6eca7-57d8-45cd-933c-69d800d8fca3');
      cy.get(`[data-cy="name"]`).should('have.value', '84f6eca7-57d8-45cd-933c-69d800d8fca3');
